...
public class MQTTReceiver : M2MqttUnityClient
{
    ...
    public string topicSubscribe = "IDD/Spec"; // topic to subscribe. !!! The multi-level wildcard # is used to subscribe to all the topics. Attention i if #, subscribe to all topics. Attention if MQTT is on data plan
    [Tooltip("Set the topic to publish (optional)")]
    public string topicPublish = "IDD/Spec"; // topic to publish
    public string messagePublish = "IDD/Spec"; // message to publish
